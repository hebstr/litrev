...
|------|---------|---------|-----------------|
| ~~2026-03-27~~ | ~~FN-3/GAP-3 : Import path pour corpus pré-existant (PMIDs, BibTeX, PDFs → combined_results.json)~~ | ~~skills/litrev/SKILL.md, skills/litrev-search/SKILL.md~~ | IN PROGRESS — Feature F dans PLAN.md |
