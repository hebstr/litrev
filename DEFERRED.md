...
| ~~2026-04-01~~ | ~~MCP tools de recherche directe (search_pubmed, search_semantic_scholar, search_openalex)~~ | ~~litrev-mcp~~ | **Promoted 2026-04-02**: now the primary fix for env/API key delivery bug → [roadmap_env_fix.md](roadmap_env_fix.md) | — |
