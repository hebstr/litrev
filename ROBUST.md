...
|--------|----------|--------|
| `/full-review` integration | Done | MCP server clean (2 micro-fixes: regex perf + type annotation), 180/180 tests OK. B1/B2/B3 instructions added to litrev-synthesize. |
| `/blindspot-review` on agents/audit_* | Optional | Not done |
| `/critical-code-reviewer` on mcp/src/ | Optional | Covered by `/full-review` — clean, no blocking issues |
