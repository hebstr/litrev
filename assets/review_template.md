...
```
("GLP-1 receptor agonist*"[tiab] OR "semaglutide"[tiab] OR "liraglutide"[tiab])
...
<!-- BibTeX block below is a working reference for cross-verification by generate_bib.py.
     The authoritative .bib file is generated from DOIs via: python scripts/generate_bib.py -->
