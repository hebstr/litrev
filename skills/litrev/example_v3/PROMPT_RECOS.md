# Recommandations pour le prompt litrev — PRISE infiltrations
...
| Type d'etudes | Observationnel surtout | Mix ECR + observationnel |
| Claims typiques | Prevalence, OR, facteurs de risque | VAS, NRS, NNT, taille d'effet, delais |
| Screening | Exclusion dominante (interventionnel) | Inclusion dominante (sujet interventionnel) |
